...
and migration checklist. Go Feather Route is the Cloud primary; LiteLLM remains
...
| Bounded retries and ordered fallbacks | Supported | Retryable HTTP responses advance through configured providers; ambiguous transport failures are not replayed | P0 |
...
| Usage and reservation accounting | Supported | Go Feather emits idempotent normalized usage events; Cloud deduplicates by request ID and owns quotas/settlement | P0 |
